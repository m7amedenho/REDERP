...
{
    /// <inheritdoc />
    public partial class RedCore : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegionLabel = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: false),
                    ...
                    CreatedByIp = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    RevokedByIp = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgUnitClosures", x => new { x.AncestorId, x.DescendantId });
                    table.ForeignKey(
                        name: "FK_OrgUnitClosures_OrgUnits_AncestorId",
                        column: x => x.AncestorId,
                        principalTable: "OrgUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrgUnitClosures_OrgUnits_DescendantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserOrgUnits", x => new { x.UserId, x.OrgUnitId });
                    table.ForeignKey(
                        name: "FK_UserOrgUnits_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRoleScopes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserRoleScopes_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoleScopes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserRoleScopes_OrgUnits_OrgUnitId",
                        column: x => x.OrgUnitId,
                        principalTable: "OrgUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrgUnitClosures_DescendantId_AncestorId_Depth",
                table: "OrgUnitClosures",
                columns: new[] { "DescendantId", "AncestorId", "Depth" });

            migrationBuilder.CreateIndex(
                name: "IX_OrgUnits_ParentId_Name_Type",
                table: "OrgUnits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoleScopes_OrgUnitId",
                table: "UserRoleScopes",
                column: "OrgUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRoleScopes_RoleId",
                table: "UserRoleScopes",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRoleScopes_UserId_RoleId_OrgUnitId",
                table: "UserRoleScopes",
                columns: new[] { "UserId", "RoleId", "OrgUnitId" },
                unique: true);
        }
